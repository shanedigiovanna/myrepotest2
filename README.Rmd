...
```{r election24, fig.align="center", fig.cap="                Coolidge won Ohio by 34.63%"}
...
```{r election28, fig.cap="                Hoover won Ohio by 30.44%", fig.align="center"}
...
```{r prog, fig.cap="                Robert La Follette won an impressive 17.75% in Ohio", fig.align="center"}
